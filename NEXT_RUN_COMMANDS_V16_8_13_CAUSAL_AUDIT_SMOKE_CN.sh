...
export SMOKE_ROOT="${SMOKE_ROOT:-/data0/senzeyu2/dataset/COWP/formal_v16_8_13_support_smoke}"
...
FRESH_LABELS="$SMOKE_ROOT/labels_val_v16_8_13"
...
BASE_SCREEN="$SMOKE_ROOT/base_screen_verdict.json"; VERDICT="$SMOKE_ROOT/v16_8_13_smoke_verdict.json"; FP_FILE="$SMOKE_ROOT/v16_8_13_code_fingerprint.sha256"
...
payload={
 'schema_version':'cowp_v16_8_13_smoke_composite_verdict_v2', 'code_fingerprint_sha256':fp,
