...
export PROBE_ROOT="${PROBE_ROOT:-/data0/senzeyu2/dataset/COWP/formal_v16_8_14_support_strict_probe}"
...
FRESH="$PROBE_ROOT/labels_val_v16_8_14"; PROFILE="$PROBE_ROOT/fresh_probe_profile.jsonl"; SUMMARY="$PROBE_ROOT/fresh_probe_profile_summary.json"
...
BASE_VERDICT="$PROBE_ROOT/base_screen_verdict.json"; VERDICT="$PROBE_ROOT/v16_8_14_strict_verdict.json"; FP="$PROBE_ROOT/v16_8_14_code_fingerprint.sha256"
