...
"""Analyze V16.8.43 blocker-conditioned RC-IARE under the frozen development protocol.
...
METHOD_KEY = "blocker_conditioned_interaction_aware_reachable_response_envelope"
CANONICAL_METHOD = "cowp_blocker_conditioned_interaction_aware_reachable_response_envelope"
...
def main() -> None:
    ...
    parser.add_argument("--blocker-conditioned-interaction-aware-reachable-response-envelope", required=True)
    ...
    data = {
        ...
        METHOD_KEY: _load(args.blocker_conditioned_interaction_aware_reachable_response_envelope),
    }
    ...
    out: dict[str, Any] = {
        "schema_version": "cowp_blocker_conditioned_interaction_aware_reachable_response_envelope_analysis_v1",
    ...
    out["blocker_conditioned_interaction_aware_reachable_response_envelope_mechanism_diagnostic"] = {
        **pooled,
