...
def _aggregate(ids: list[str], old: dict, new: dict) -> tuple[Counter, list[int], list[int]]:
    ...
    for sid in ids:
        ...
        c.update(
            ...
            old_any_conv=int(bool(a["any_conv"])),
            new_any_conv=int(bool(b["any_conv"])),
            old_any_ncf=int(bool(a["any_ncf"])),
            new_any_ncf=int(bool(b["any_ncf"])),
            ncf_retained=int(bool(a["any_ncf"] and b["any_ncf"])),
            ncf_gained=int(bool((not a["any_ncf"]) and b["any_ncf"])),
            ...
            new_psy_candidates=int(b.get("psy_count", 0)),
            new_psy_ncf_candidates=int(b.get("psy_ncf_count", 0)),
            new_psy_priority_ncf_candidates=int(b.get("psy_priority_ncf_count", 0)),
...
def main() -> None:
    ...
    result = {
        ...
        "old": {
            ...
            "any_conventional_safe_scene_rate": _rate(c["old_any_conv"], n),
            "any_ncf_scene_rate": _rate(c["old_any_ncf"], n),
            "any_priority_eligible_scene_rate": _rate(c["old_priority_eligible"], n),
            "any_priority_ncf_scene_rate": _rate(c["old_priority_eligible"] - c["old_priority_floor"], n),
        ...
        "new": {
            ...
            "any_conventional_safe_scene_rate": _rate(c["new_any_conv"], n),
            "any_ncf_scene_rate": new_any_ncf,
            "any_priority_eligible_scene_rate": _rate(c["new_priority_eligible"], n),
            "any_priority_ncf_scene_rate": _rate(c["new_priority_eligible"] - c["new_priority_floor"], n),
            ...
            "scene_with_priority_smooth_yield_rate": _rate(c["new_scene_with_psy"], n),
            "scene_with_priority_smooth_yield_ncf_rate": _rate(c["new_scene_with_psy_ncf"], n),
            "scene_with_priority_smooth_yield_priority_ncf_rate": _rate(c["new_scene_with_psy_priority_ncf"], n),
        ...
        "paired": {
            ...
            "old_ncf_scene_count": int(c["old_any_ncf"]),
            "new_ncf_scene_count": int(c["new_any_ncf"]),
            "ncf_retained_scene_count": int(c["ncf_retained"]),
            "ncf_gained_scene_count": int(c["ncf_gained"]),
            "ncf_lost_scene_count": int(c["ncf_lost"]),
            "ncf_retention_rate_given_old_ncf": _rate(c["ncf_retained"], c["old_any_ncf"]),
            "ncf_gain_rate_given_old_non_ncf": _rate(c["ncf_gained"], n - c["old_any_ncf"]),
