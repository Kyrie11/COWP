...
"""Analyze V16.8.45 verified root-conditioned recourse-set operator (RCRSO) under the frozen development protocol.
...
METHOD_KEY = "verified_root_conditioned_recourse_set_operator"
CANONICAL_METHOD = "cowp_verified_root_conditioned_recourse_set_operator"
...
_DIAGNOSTIC_KEYS = [
    ...
    "mean_recovery_tube_blocker_query_rcrso_attempts_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_proposals_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_profile_evaluations_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_verified_profiles_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_selected_roots_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_burden_rejects_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_roadgraph_or_waymax_kinematic_rejects_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_ego_current_rejects_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_ego_shift_rejects_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_environment_rejects_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_environment_cache_hits_on_attempts",
    "recovery_tube_blocker_query_rcrso_selection_rate_on_certified_steps",
    "mean_recovery_tube_blocker_query_rcrso_joint_assignment_profiles_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_certified_hypotheses_on_attempts",
    "mean_recovery_tube_blocker_query_rcrso_selected_assignment_profiles_on_rcrso_steps",
...
def _pooled_interaction_mechanism(
    ...
    rcrso_selected = _count_from_rate(
        rows, ids, "recovery_tube_blocker_query_rcrso_selection_rate_on_certified_steps", certificates
    )
    return {
...
def _pooled_blocker_query_mechanism(
    ...
    mean_keys = {
        ...
        "rcrso_attempts": "mean_recovery_tube_blocker_query_rcrso_attempts_on_attempts",
        "rcrso_proposals": "mean_recovery_tube_blocker_query_rcrso_proposals_on_attempts",
        "rcrso_profile_evaluations": "mean_recovery_tube_blocker_query_rcrso_profile_evaluations_on_attempts",
        "rcrso_verified_profiles": "mean_recovery_tube_blocker_query_rcrso_verified_profiles_on_attempts",
        "rcrso_selected_roots": "mean_recovery_tube_blocker_query_rcrso_selected_roots_on_attempts",
        "rcrso_burden_rejects": "mean_recovery_tube_blocker_query_rcrso_burden_rejects_on_attempts",
        "rcrso_roadgraph_or_waymax_kinematic_rejects": "mean_recovery_tube_blocker_query_rcrso_roadgraph_or_waymax_kinematic_rejects_on_attempts",
        "rcrso_ego_current_rejects": "mean_recovery_tube_blocker_query_rcrso_ego_current_rejects_on_attempts",
        "rcrso_ego_shift_rejects": "mean_recovery_tube_blocker_query_rcrso_ego_shift_rejects_on_attempts",
        "rcrso_environment_rejects": "mean_recovery_tube_blocker_query_rcrso_environment_rejects_on_attempts",
        "rcrso_environment_cache_hits": "mean_recovery_tube_blocker_query_rcrso_environment_cache_hits_on_attempts",
        "rcrso_joint_assignment_profiles": "mean_recovery_tube_blocker_query_rcrso_joint_assignment_profiles_on_attempts",
        "rcrso_certified_hypotheses": "mean_recovery_tube_blocker_query_rcrso_certified_hypotheses_on_attempts",
    ...
    return {
        ...
        "total_rcrso_selected_certificate_steps": rcrso_selected,
        ...
        "rcrso_selection_rate_on_certified_steps": float(rcrso_selected / total_certificates) if total_certificates else None,
        "rcrso_mechanism_nonzero": bool(rcrso_selected > 0),
...
def main() -> None:
    ...
    parser.add_argument("--verified-root-conditioned-recourse-set-operator", required=True)
    ...
    data = {
        ...
        METHOD_KEY: _load(args.verified_root_conditioned_recourse_set_operator),
    }
    ...
    out: dict[str, Any] = {
        "schema_version": "cowp_verified_root_conditioned_recourse_set_operator_analysis_v1",
    ...
    out["verified_root_conditioned_recourse_set_operator_mechanism_diagnostic"] = {
        **pooled,
        ...
        "interpretation": (
            "The inherited six-item outcome conjunction gate is unchanged. V16.8.45 preserves the V42/V43 exact-blocker interaction certificate and replaces only the failed finite analytic responder-completion proposal family with a learned set-valued proposer. Every proposed response is rechecked by the frozen burden, roadgraph, Waymax-kinematics, ego-current/shift, environment and exact multi-root/multi-blocker CSP verifier. RCRSO changes proposal completeness only; it cannot weaken hard-set soundness or the frozen promotion gate."
        ),
    }
