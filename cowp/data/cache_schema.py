...
COWP_SCHEMA: dict[str, FieldSpec] = {
    ...
    "cowp/candidates/certificate_valid": FieldSpec(("K",), "b", required=False),
    ...
    "cowp/candidates/priority_eligible": FieldSpec(("K",), "b", required=False),
    "cowp/candidates/priority_false_safe": FieldSpec(("K",), "b", required=False),
    "cowp/candidates/priority_noncoercive_feasible": FieldSpec(("K",), "b", required=False),
    ...
    "cowp/critical/mechanism_valid": FieldSpec(("A",), "b", required=False),
    "cowp/critical/auditability_reason": FieldSpec(("A",), ("i", "u"), required=False),
    ...
    "cowp/natural/map_evidence_mode": FieldSpec(("A", "M"), ("i", "u"), required=False),
