...
run model_support_labels_train "$PYTHON_BIN" -m cowp.scripts.65_audit_model_support \
  --cache-dir "$LABELS_TRAIN" --sample-scenes 0 --min-class-examples 128 --min-source-examples 128 --max-unauditable-critical-rate 0.05 --min-certificate-complete-scene-rate 0.75 --min-protected-prio-coverage 0.98 --coverage-gate-mode point --strict \
...
run model_support_labels_val "$PYTHON_BIN" -m cowp.scripts.65_audit_model_support \
  --cache-dir "$LABELS_VAL" --sample-scenes 0 --min-class-examples 32 --min-source-examples 32 --max-unauditable-critical-rate 0.05 --min-certificate-complete-scene-rate 0.75 --min-protected-prio-coverage 0.98 --coverage-gate-mode point --strict \
...
run model_support_cache_train "$PYTHON_BIN" -m cowp.scripts.65_audit_model_support \
  --cache-dir "$TRAIN_CACHE_FINAL" --sample-scenes 0 --min-class-examples 128 --min-source-examples 128 --max-unauditable-critical-rate 0.05 --min-certificate-complete-scene-rate 0.75 --min-protected-prio-coverage 0.98 --coverage-gate-mode point --strict \
...
run model_support_cache_val "$PYTHON_BIN" -m cowp.scripts.65_audit_model_support \
  --cache-dir "$VAL_CACHE_FINAL" --sample-scenes 0 --min-class-examples 32 --min-source-examples 32 --max-unauditable-critical-rate 0.05 --min-certificate-complete-scene-rate 0.75 --min-protected-prio-coverage 0.98 --coverage-gate-mode point --strict \
