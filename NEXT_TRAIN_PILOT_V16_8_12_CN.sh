...
export TRAIN_PILOT_ROOT="${TRAIN_PILOT_ROOT:-/data0/senzeyu2/dataset/COWP/formal_v16_8_12_train_pilot}"
...
FRESH="$TRAIN_PILOT_ROOT/labels_train_v16_8_12"
...
VERDICT="$TRAIN_PILOT_ROOT/v16_8_12_train_pilot_verdict.json"
FP_FILE="$TRAIN_PILOT_ROOT/v16_8_12_code_fingerprint.sha256"
...
payload={
  'schema_version':'cowp_v16_8_12_train_pilot_verdict_v1',
