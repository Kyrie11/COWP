...
FRESH_LABELS="$SMOKE_ROOT/labels_val_v16_8_15"
...
BASE_SCREEN="$SMOKE_ROOT/base_screen_verdict.json"; VERDICT="$SMOKE_ROOT/v16_8_15_smoke_verdict.json"; FP_FILE="$SMOKE_ROOT/v16_8_15_code_fingerprint.sha256"
...
# v16.8.15: derive the stress manifest from the CURRENT old validation cache.
...
payload={
 'schema_version':'cowp_v16_8_15_smoke_composite_verdict_v2', 'code_fingerprint_sha256':fp,
