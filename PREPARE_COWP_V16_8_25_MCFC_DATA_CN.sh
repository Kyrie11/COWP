...
# Compact, property-complete v16.8.25-MCFC full dataset builder.
...
COWP_ROOT="${COWP_ROOT:-/data0/senzeyu2/dataset/COWP/formal_v16_8_25_mcfc_compact_full_5k}"
...
# Deliberately preserve the v16.8.24 split seed so v16.8.25 is a paired algorithm/data-semantic comparison, not a split change.
LABEL_CFG="${LABEL_CFG:-configs/label_cowp_v16_8_25_mcfc.yaml}"
...
manifest={
 ...
 'producer_version':'v16.8.25-MCFC-rebuild-ready',
...
m=importlib.import_module('cowp.scripts.59_gate_fresh_v16_8_9_cache_protocol')
manifest={
 'schema_version':'cowp_v16_8_25_mcfc_compact_full_manifest_v1',
 'producer_version':'v16.8.25-MCFC-rebuild-ready',
...
(root/'data_manifest_v16_8_25_mcfc.json').write_text(json.dumps(manifest,indent=2,ensure_ascii=False)+'\n')
payload={'schema_version':'cowp_v16_8_25_mcfc_compact_full_support_v1','pass':all(checks.values()),'checks':checks,
...
(root/'full_core_support_verdict_v16_8_25_mcfc.json').write_text(json.dumps(payload,indent=2,ensure_ascii=False)+'\n')
print(json.dumps(payload,indent=2,ensure_ascii=False))
if not payload['pass']: raise SystemExit(2)
PY

echo "V16.8.25-MCFC COMPACT FULL train/val/heldout-test BUILD PASS: $COWP_ROOT"
