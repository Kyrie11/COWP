...
MAIN_OUT_ROOT="${MAIN_OUT_ROOT:-outputs/cowp_v16_3_natural_recovery_v9labels_seed2026}"
ABL_ROOT="${ABL_ROOT:-outputs/cowp_v16_3_natural_ablations_v9labels_seed2026}"
