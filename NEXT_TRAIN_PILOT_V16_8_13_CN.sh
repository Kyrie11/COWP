...
FRESH="$TRAIN_PILOT_ROOT/labels_train_v16_8_13"
...
VERDICT="$TRAIN_PILOT_ROOT/v16_8_13_train_pilot_verdict.json"
FP_FILE="$TRAIN_PILOT_ROOT/v16_8_13_code_fingerprint.sha256"
...
payload={
  'schema_version':'cowp_v16_8_13_train_pilot_verdict_v2',
