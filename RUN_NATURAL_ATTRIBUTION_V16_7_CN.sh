...
MAIN_OUT_ROOT="${MAIN_OUT_ROOT:-outputs/cowp_v16_7_natural_recovery_seed2026}"
SOURCE_ABL_ROOT="${SOURCE_ABL_ROOT:-outputs/cowp_v16_7_natural_ablations_seed2026}"
ATTR_OUT_ROOT="${ATTR_OUT_ROOT:-outputs/cowp_v16_7_natural_attribution_aligned_seed2026}"
...
echo "[v16.7 attribution] aligned checkpoint epoch=$TARGET_EPOCH"
...
run_or_resolve_arm() {
  ...
  echo "[v16.7 attribution] exact epoch checkpoint missing for $name; retraining only to epoch $TARGET_EPOCH" >&2
...
x={
  'version':'v16.7', 'checkpoint_policy':'same_main_selected_epoch',
