...
export OUT_ROOT="${OUT_ROOT:-outputs/cowp_v16_7_pipeline_v9labels_seed2026}"
...
if [[ "$BACKGROUND" == "1" && "${COWP_V16_7_BACKGROUND_CHILD:-0}" != "1" ]]; then
  export COWP_V16_7_BACKGROUND_CHILD=1
  ...
  echo "[cowp_v16.7] log=$OUT_ROOT/logs/driver.nohup.log"
  exit 0
fi
...
bash run_cowp_v16_7_dual_gpu.sh
