...
# v16.8 changes transport/root/candidate certification heads.  Train them from
# the validated natural checkpoint in a fresh provenance root; do not resume a
# v16.6 transport/planner optimizer state.
export TRANSPORT_EPOCHS="${TRANSPORT_EPOCHS:-24}"
export PLANNER_EPOCHS="${PLANNER_EPOCHS:-16}"
