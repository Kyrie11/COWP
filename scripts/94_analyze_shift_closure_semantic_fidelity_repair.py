...
def main() -> None:
    ...
    parser.add_argument("--shift-closure-semantic-fidelity-repair", required=True)
    ...
    data = {
        ...
        "shift_closure_semantic_fidelity_repair": _load(
            args.shift_closure_semantic_fidelity_repair
        ),
    }
    ...
    out: dict[str, Any] = {
        "schema_version": "cowp_shift_closure_semantic_fidelity_repair_analysis_v1",
    ...
    name = "shift_closure_semantic_fidelity_repair"
    if "rvr" in rowmap:
    ...
    out["shift_closure_semantic_fidelity_repair_mechanism_diagnostic"] = {
        **pooled,
        ...
        "interpretation": (
            ...
            "attribute any gain specifically to the repaired V40 first-action interval "
            "mechanism. V41 changes only all-horizon shift-terminal semantics; "
            "it is a reliability rerun, not a new algorithmic contribution or a "
            "post-hoc additional promotion threshold."
        ),
    }
